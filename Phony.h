...
@property (nonatomic, copy, nullable) void (^handler)(BOOL, NSString* _Nullable);
 ...
 */
- (void)confirmPhoneNumber:(NSString *_Nonnull)number completion:(void (^ _Nullable)(NSString * _Nullable replyTo, NSString * _Nullable content, NSError * _Nullable error))handler;
 ...
 *  @return NO if the
 */
- (BOOL)authenticateWithDefaultTextMessageDialog:(NSString * _Nonnull)replyTo content:(NSString * _Nonnull)content handler:(void (^ _Nullable)(BOOL authenticated, NSString * _Nullable firebase))authHandler;
